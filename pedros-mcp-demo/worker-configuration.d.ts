/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 799be9f08e14353ac53a5c0a907c5126)
// Runtime types generated with workerd@1.20260710.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	DEMO_BASE_URL: "http://localhost:8787";
	PAYFAST_MERCHANT_ID: string;
	PAYFAST_MERCHANT_KEY: string;
	PAYFAST_PASSPHRASE: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").MyMCP>;
	ORDER_STORE: DurableObjectNamespace<import("./src/index").OrderStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MyMCP" | "OrderStore";
	}
