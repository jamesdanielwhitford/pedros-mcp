...
You'll need to repeat [Step 2.1](https://developers.cloudflare.com/agents/model-context-protocol/guides/remote-mcp-server/#step-21--create-a-new-oauth-app-for-local-development) to create a new OAuth App for production.
